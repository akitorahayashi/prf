...
- `src/targets/` – Authoritative category catalog, typed candidates, and target-specific ownership.
- `src/fs/` – Validated roots, allocated-size measurement, revalidation, and deletion mechanics.
...
- Missing or invalid roots fail without a substitute scope.
